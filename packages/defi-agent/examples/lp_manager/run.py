...
from defi_agent import AgentConfig, DeFiAgent, make_lp_policy
from defi_agent.llm_client import MockLLMClient, OpenAICompatibleLLMClient
from defi_agent.prompts import LP_SYSTEM_PROMPT
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run LP manager agent.")
...
async def main() -> None:
    ...
    if args.mock:
        llm_client = MockLLMClient(
            [
                {"type": "tool", "tool": "get_price", "arguments": {"symbol": "WAVAX"}},
                {
                    "type": "tool",
                    "tool": "record_decision",
                    "arguments": {"decision": "hold", "reason": "Position still in range"},
                },
